...
export const campaignsInfo: (Campaign & {
...
})[] = [
  {
    ...
    campaignStatus: {
      campaign_info: {
        ...
        reward_distribution_type: { Daily: { num_of_days: 7 } },
        target_position: 103,
        validator_address:
      ...
      state: {
        RewardsDistribution: {
          disbursements_remaining: 4,
          last_distribution: "2023-11-01T14:48:00.000Z",
          total_distributed: [
            coin(
              300_000_000,
              "ibc/F04D72CF9B5D9C849BB278B691CDFA2241813327430EC9CDC83F8F4CA4CDC2B0"
...

  {
    ...
    campaignStatus: {
      ...
      state: { PendingStart: "OpeningIcaChannel" } as const,
    },
    pledges: [
      {
        amount: (1_000_000).toString(),
